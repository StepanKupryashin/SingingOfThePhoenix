...
define config.name = _("Singing of the Phoenix")
...
define gui.about = _p(""" не забудь заполнить до конца :)
""")
...
define config.save_directory = "SingingofthePhoenix_-1659698695"
